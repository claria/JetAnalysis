...
class JetSettings : public KappaSettings {
 public:
  ...
  IMPL_SETTING_DEFAULT(double, MinValidJetPt,
                       std::numeric_limits<double>::min())
  IMPL_SETTING_DEFAULT(double, MinValidJetAbsRap,
                       std::numeric_limits<double>::min())
  IMPL_SETTING_DEFAULT(double, MaxValidJetAbsRap,
                       std::numeric_limits<double>::max())

  // Number of minimum required valid jets
  IMPL_SETTING_DEFAULT(int, MinValidJets, 0)

  IMPL_SETTING_DEFAULT(double, MinLeadingJetPt,
                       std::numeric_limits<double>::min())
  IMPL_SETTING_DEFAULT(double, MaxLeadingJetPt,
                       std::numeric_limits<double>::max())

  IMPL_SETTING_DEFAULT(double, MinLeadingJetAbsRap,
                       std::numeric_limits<double>::min())
  IMPL_SETTING_DEFAULT(double, MaxLeadingJetAbsRap,
                       std::numeric_limits<double>::max())
  IMPL_SETTING_DEFAULT(double, MinSecondJetAbsRap,
                       std::numeric_limits<double>::min())
  IMPL_SETTING_DEFAULT(double, MaxSecondJetAbsRap,
                       std::numeric_limits<double>::max())

  IMPL_SETTING_DEFAULT(double, MinDijetsAbsRap,
                       std::numeric_limits<double>::min())
  IMPL_SETTING_DEFAULT(double, MaxDijetsAbsRap,
                       std::numeric_limits<double>::max())
  // MET Filter
  IMPL_SETTING_DEFAULT(double, MaxMETSumEtRatio,
                       std::numeric_limits<double>::max())

  // GenJetMatcher
  IMPL_SETTING_DEFAULT(double, MaxDeltaR, std::numeric_limits<double>::max())
  IMPL_SETTING_DEFAULT(double, MaxDeltaPtRel,
                       std::numeric_limits<double>::max())
