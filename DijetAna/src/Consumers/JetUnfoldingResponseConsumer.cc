...
void JetUnfoldingResponseConsumer::Init(setting_type const& settings) {
  ...
  TH3D reco_binning_jet12rap("reco_binning_jet12rap", "reco_binning_jet12rap", settings.GetRapidityAbsBinning().size() - 1,
  ...
  TH3D reco_binning_ptavg_yio("reco_binning_ptavg_yio", "reco_binning_ptavg_yio", settings.GetRapidityAbsBinning().size() - 1,
                             &settings.GetRapidityAbsBinning()[0], settings.GetRapidityAbsBinning().size() - 1,
                             &settings.GetRapidityAbsBinning()[0], settings.GetTripleDiffPtBinning().size() - 1,
                             &settings.GetTripleDiffPtBinning()[0]);
  TH3D gen_binning_ptavg_yio("gen_binning_ptavg_yio", "gen_binning_ptavg_yio", settings.GetRapidityAbsBinning().size() - 1,
                              &settings.GetRapidityAbsBinning()[0], settings.GetRapidityAbsBinning().size() - 1,
                              &settings.GetRapidityAbsBinning()[0], settings.GetTripleDiffGenPtBinning().size() - 1,
                              &settings.GetTripleDiffGenPtBinning()[0]);

  TH3D reco_binning_ptavg_ysb("reco_binning_ptavg_ysb", "reco_binning_ptavg_ysb", settings.GetRapidityAbsBinning().size() - 1,
                          &settings.GetRapidityAbsBinning()[0], settings.GetRapidityAbsBinning().size() - 1,
                          &settings.GetRapidityAbsBinning()[0], settings.GetTripleDiffPtBinning().size() - 1,
                          &settings.GetTripleDiffPtBinning()[0]);
  TH3D gen_binning_ptavg_ysb("gen_binning_ptavg_ysb", "gen_binning_ptavg_ysb", settings.GetRapidityAbsBinning().size() - 1,
                           &settings.GetRapidityAbsBinning()[0], settings.GetRapidityAbsBinning().size() - 1,
                           &settings.GetRapidityAbsBinning()[0], settings.GetTripleDiffGenPtBinning().size() - 1,
                           &settings.GetTripleDiffGenPtBinning()[0]);
  ...
  m_unfoldResponse_jet12rap = new RooUnfoldResponse(&reco_binning_jet12rap, &gen_binning_jet12rap, "res_matrix_jet12rap", "res_matrix_jet12rap");
  m_unfoldResponse_ptavg_yio = new RooUnfoldResponse(&reco_binning_ptavg_yio, &gen_binning_ptavg_yio, "res_matrix_ptavg_yio", "res_matrix_ptavg_yio");
  m_unfoldResponse_ptavg_ysb = new RooUnfoldResponse(&reco_binning_ptavg_ysb, &gen_binning_ptavg_ysb, "res_matrix_ptavg_ysb", "res_matrix_ptavg_ysb");
