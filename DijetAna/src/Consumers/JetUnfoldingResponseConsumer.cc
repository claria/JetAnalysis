...
void JetUnfoldingResponseConsumer::Init(setting_type const& settings) {
  ...
  TH3D meas_binning_jet12rapsign("meas_binning_jet12rapsign",
                                 "meas_binning_jet12rapsign",
  ...
  m_unfoldResponse_jet12rap =
      new RooUnfoldResponse(&meas_binning_jet12rap, &truth_binning_jet12rap,
                            "res_matrix_jet12rap", "res_matrix_jet12rap");
  m_unfoldResponse_jet12rapsign = new RooUnfoldResponse(
      &meas_binning_jet12rapsign, &truth_binning_jet12rapsign,
  ...
  // "res_matrix_jet12rapsign", "res_matrix_jet12rapsign");
  m_unfoldResponse_pt = new RooUnfoldResponse(
      &meas_binning_pt, &truth_binning_pt, "res_matrix_pt", "res_matrix_pt");
}
...
void JetUnfoldingResponseConsumer::ProcessFilteredEvent(
...
void JetUnfoldingResponseConsumer::Finish(setting_type const& settings) {
  ...
  m_unfoldResponse_jet12rapsign->Write(
      m_unfoldResponse_jet12rapsign->GetName());
