...
bool DijetsRapFilter::DoesEventPass(JetEvent const& event, JetProduct const& product, JetSettings const& settings) const {
	bool pass = false;
	// std::cout << "minmaxcuts " << minDijetsAbsRap << " " << maxDijetsAbsRap << std::endl;
